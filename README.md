...
## Info
The Schoology API is an application that communicates with Schoology's server and returns data through HTTP. Unlike many APIs today, Schoology uses the OAuth 1.0a method. To quickly follow along, you can use [Postman](https://www.postman.com/) to easily make requests.
